...
export function ScrollArea({ children }: React.PropsWithChildren) {
  return (
    <BaseUiScrollArea.Root className="h-full">
      ...
      <BaseUiScrollArea.Scrollbar className="m-1 flex w-1.5 justify-center rounded opacity-0 transition-opacity delay-300 data-[hovering]:opacity-100 data-[hovering]:delay-0 data-[hovering]:duration-75 data-[scrolling]:opacity-100 data-[scrolling]:delay-0 data-[scrolling]:duration-75">
