// I don't think we need to test this module. It is part of the public API but
// it is not performing any logic and just delegating to the rfd crate.
// Thus, why I commented it out.
